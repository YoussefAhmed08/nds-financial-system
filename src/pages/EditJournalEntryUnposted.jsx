...
function EditJournalEntryUnposted() {
  ...
  return (
    <div className="flex flex-col gap-10 px-10">
      ...
      <div className="flex items-center gap-5">
        <div className="flex items-center justify-center w-[210px] h-12 -ml-8 -mt-16">
          <p className="text-[#979797]  text-lg">
            {t("Journal NO")} <br />{" "}
            <p className="text-[#46433F]  text-lg">2</p>
          </p>
        </div>
        <div className="flex items-center justify-center w-[210px] h-12 -ml-8 -mt-16">
          <p className="text-[#979797]  text-lg">
            {t("Journal Status")} <br />{" "}
            <p className="text-[#E1044C]  text-lg">{t("Un Posted")}</p>
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-5 ml-10">
        ...
        <button
          disabled
          className="flex items-center justify-center w-[196px] h-[53px] rounded-2xl bg-[#127CF5] text-[white]  text-lg font-medium opacity-30"
        >
          {t("REVERSE")}
        </button>
        <button className="w-[196px] h-[53px] rounded-2xl bg-[#E1044C] text-[white]  text-lg font-medium">
          {t("DELETE")}
        </button>
...
export default EditJournalEntryUnposted;
